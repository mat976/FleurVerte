 ...
 */
final class Version20241128075706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fleur CHANGE stock stock INT DEFAULT NULL');
        $this->addSql('ALTER TABLE fleuriste ADD adresse_id INT DEFAULT NULL, CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fleuriste DROP adresse_id, CHANGE user_id user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE fleur CHANGE stock stock INT NOT NULL');
    }
}
